...
public class FormUpdaterOka {
    ...
    public Boolean add(String kelamin, int umur, String kode_pos, String jenis_kelamin) {
        String sql = "INSERT INTO oka(kelamin,umur,negara,jenis_kelamin) VALUES ('" + kelamin + "','" + umur + "','" + kode_pos + "','" + jenis_kelamin + "')";
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
            s.execute(sql);
    ...
    public DefaultTableModel getData() {
        ...
        String sql = "select oka.id_coba,kelamin,umur, negara,pekerjaan,cluster from oka;";
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
    ...
    public Boolean update(int cluster, String kelamin, String umur, String negara) {
        String sql = "UPDATE oka SET kelamin='" + kelamin + "',umur='" + umur + "',negara='" + negara + "' WHERE cluster='" + cluster + "'";
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
            s.execute(sql);
    ...
    public Boolean updatecluster(int id_coba, int cluster) {
        String sql = "UPDATE oka SET cluster='" + cluster + "' WHERE id_coba='" + id_coba + "'";
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
            s.execute(sql);
    ...
    public Boolean updateclusterkedua(int cluster) {
        ...
        String sql = "UPDATE oka SET cluster='" + clusterbaru + "' WHERE cluster='" + cluster + "'";
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
            s.execute(sql);
    ...
    public Boolean updateclusterfixz(int cluster) {
        int clusterbaru = cluster - 1;
        String sql = "UPDATE oka SET cluster='" + clusterbaru + "' WHERE cluster='" + cluster + "'";
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
    ...
    public Boolean updateNegara(int id, String negara) {
        String sql = "UPDATE oka SET negara='" + negara + "' WHERE id_coba='" + id + "'";
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
            s.execute(sql);
    ...
    public int selectMax(int maxcluster) {
        String sql = "select max(id_coba) from oka where cluster='" + maxcluster + "';";
        int id_coba = 0;
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
...
//            looping
    ...
    public int selectMaxUmur() {
        String sql = "select max(umur) from oka;";
        int id_coba = 0;
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
...
//            looping
    ...
    public int selectMin(int maxcluster) {
        String sql = "select min(id_coba) from oka where cluster='" + maxcluster + "';";
        int id_coba = 0;
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
...
//            looping
        ...
        String sql = "select min(umur) from oka;";
        int id_coba = 0;
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
...
//            looping
    ...
    public int cariBanyakDataDalamCluster(int maxcluster) {
        String sql = "select count(cluster) from oka where cluster='" + maxcluster + "';;";
        int id_coba = 0;
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
...
//            looping
    ...
    public int selectMaxOka() {
        String sql = "select max(cluster) from oka;";
        int id_coba = 0;
        try {
            Connection con = DriverManager.getConnection(consString, username, password);
            Statement s = con.prepareStatement(sql);
